...
server <- function(input, output, session) {
  ...
  # Cambiar a la pestaña de ingreso de datos cuando se haga clic en "Ingresar"
  observeEvent(input$login_btn, {
    updateTabItems(session, "tabs", "ingreso")
  })
  
  # Cambiar a la pestaña de impacto económico cuando se haga clic en "Calcular"
