...
function col_height() { return svg_height() / data.length * layer_height; }
...
bars.enter().append('rect')
    ...
    .attr('height', col_height() * 0.9)
    .attr('y', function(d, i) { return i * col_height() + col_top(); })
    .attr('x', col_left())
    .attr('fill', '#0072B2')
...
txt.enter().append('text')
    ...
    .attr('y', function(d, i) { return i * col_height() + (col_height() / 2) + col_top(); })
